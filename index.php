...
<head>
    ...
    <link rel="stylesheet" href="static/css/index8a.css?v=1">
  ...
  <body style="height: 58vh;">
    <div class="hole"> 
       <div class="item1">
        <div class="child2">BUY T-SHIRTS</div>
       ...
       <div id="log" class="child10">LOG IN</div>
      ...
      <div class="item10">
        ...
        <div class="item15">
          ...
          <div class="item15c">
           ...
           <div id="login"><div class="bs"><h1>JOIN US</h1> <p>The base collection - Ideal every day</p></div>
          ...
          $hh = mysqli_fetch_assoc($conselect1);
               ...
               ?>
            <div>
            <input class="input2" type="email"  name ="email" placeholder=" e-mail..." />
            <?php
            if(!empty($emailerror)){?>
            ...
            <input class="bb"  type="submit"  name="btn"></input>
         ...
         <div id="register"><div class="bsa"><h1>JOIN US</h1> <p>The base collection - Ideal every day</p>
...
?>
           ...
           <input class="inputa" type="text" name="name" placeholder=" name..."  required/>
             <br>
             <input class="input2a" type="email" name="email" placeholder=" e-mail..." required />
             <?php  if(empty($emailerror)){ }else{ echo $emailerror; } ?>
             <br>
             <input class="input3a" type="password" name="pass" placeholder=" password..."  required/>
             <input class="bba" name="btn2" type="submit" ></input>
           </form>
    ...
    <script src="static/js/project20a.js"></script>
